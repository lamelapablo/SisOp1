...
def ejecucionAsincrona(ct0,ct1,ct2):
    '''
        Ejecución asincrónica (o concurrente) 
    '''
    print("-"*20)
...
def ejecucionSincrona(ct0,ct1,ct2):
    '''
        Ejecución sincrónica (o secuencial) 
    '''
    print("-"*20)
    print("INICIO del Proceso\n",end="")
    print("....................")
...
def main():
    # Por cada thread, cantidad de elementos que se generará en una lista (función que ejecuta el thread)
    ct0=1000000
    ct1=50000000
    ct2=1000000
    
    print("* * * I N I C I O  EJECUTA ASINCRONO * * * ")
    ejecucionAsincrona(ct0,ct1,ct2)
    print("* * * F I N   EJECUTA ASINCRONO * * *")
    print("# # # # # # # # # # # # # # # # # # # # # # # # ")
    print("* * * I N I C I O  EJECUTA SINCRONA * * * ")
    ejecucionSincrona(ct0,ct1,ct2)
